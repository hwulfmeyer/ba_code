...
if __name__ == "__main__":
    ...
    datasets = ["f2_n2000_python",
    "f2_alt_n2000_python",
    "f2_noisy_1p_n2000_python",
    "f2_noisy_5p_n2000_python",
    "f1_n2000_python",
    "f1_noisy_1p_n2000_python",
    "f1_noisy_5p_n2000_python"]
    funcs = [Linear,
    Polynomial4,
    GradientTrees,
    GaussProcess,
    DeepMLP200x4]
    random_state = np.random.RandomState(465)
    ...
    for dataset in datasets:
        ...
        if isinstance(dataset, str):
            ...
            print("\n" + dataset.DESCR[:dataset.DESCR.find('\n')])
            X = dataset.data
            y = dataset.target
